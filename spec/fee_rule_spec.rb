...
describe '料金ルール' do
  ...
  context '障がい者（学生以上）' do
    let(:customer_type) { CustomerType::Handicapped }

    context '平日' do
      context '~20:00' do
        let(:at) { ScreeningAt.parse('2019-07-10 15:30') }
        it { is_expected.to eq(Fee.new(CustomerType::Handicapped, DayType::Weekday, ShowType::Normal)) }
      end
      ...
      context '20:00~' do
        ...
        context '通常上映' do
          it { is_expected.to eq(Fee.new(CustomerType::Handicapped, DayType::Weekday, ShowType::Late)) }
        end
    ...
    context '土日祝' do
      context '~20:00' do
        let(:at) { ScreeningAt.parse('2019-07-13 15:30') }
        it { is_expected.to eq(Fee.new(CustomerType::Handicapped, DayType::Holiday, ShowType::Normal)) }
      end
      ...
      context '20:00~' do
        ...
        context '通常上映' do
          it { is_expected.to eq(Fee.new(CustomerType::Handicapped, DayType::Holiday, ShowType::Late)) }
        end
    ...
    context '映画の日（平日）' do
      let(:at) { ScreeningAt.parse('2019-07-01 15:30') }
      it { is_expected.to eq(Fee.new(CustomerType::Handicapped, DayType::DayOfCinema, nil)) }
    end
  ...
  context '障がい者（高校生以下）' do
    let(:customer_type) { CustomerType::HandicappedUnderHighSchoolStudent }

    context '平日' do
      context '~20:00' do
        let(:at) { ScreeningAt.parse('2019-07-10 15:30') }
        it { is_expected.to eq(Fee.new(CustomerType::HandicappedUnderHighSchoolStudent, DayType::Weekday, ShowType::Normal)) }
      end
      ...
      context '20:00~' do
        ...
        context '通常上映' do
          it { is_expected.to eq(Fee.new(CustomerType::HandicappedUnderHighSchoolStudent, DayType::Weekday, ShowType::Late)) }
        end
    ...
    context '土日祝' do
      context '~20:00' do
        let(:at) { ScreeningAt.parse('2019-07-13 15:30') }
        it { is_expected.to eq(Fee.new(CustomerType::HandicappedUnderHighSchoolStudent, DayType::Holiday, ShowType::Normal)) }
      end
      ...
      context '20:00~' do
        ...
        context '通常上映' do
          it { is_expected.to eq(Fee.new(CustomerType::HandicappedUnderHighSchoolStudent, DayType::Holiday, ShowType::Late)) }
        end
    ...
    context '映画の日（平日）' do
      let(:at) { ScreeningAt.parse('2019-07-01 15:30') }
      it { is_expected.to eq(Fee.new(CustomerType::HandicappedUnderHighSchoolStudent, DayType::DayOfCinema, nil)) }
    end
  ...
  context 'エムアイカード' do
    let(:customer_type) { CustomerType::MICard }

    context '平日' do
      context '~20:00' do
        let(:at) { ScreeningAt.parse('2019-07-10 15:30') }
        it { is_expected.to eq(Fee.new(CustomerType::MICard, DayType::Weekday, ShowType::Normal)) }
      end
      ...
      context '20:00~' do
        ...
        context '通常上映' do
          it { is_expected.to eq(Fee.new(CustomerType::MICard, DayType::Weekday, ShowType::Late)) }
        end
    ...
    context '土日祝' do
      context '~20:00' do
        let(:at) { ScreeningAt.parse('2019-07-13 15:30') }
        it { is_expected.to eq(Fee.new(CustomerType::MICard, DayType::Holiday, ShowType::Normal)) }
      end
      ...
      context '20:00~' do
        ...
        context '通常上映' do
          it { is_expected.to eq(Fee.new(CustomerType::MICard, DayType::Holiday, ShowType::Late)) }
        end
    ...
    context '映画の日（平日）' do
      ...
      context '20:00~' do
        let(:at) { ScreeningAt.parse('2019-07-01 20:15') }
    ...
    context '映画の日（土日祝）' do
      ...
      context '20:00~' do
        let(:at) { ScreeningAt.parse('2019-06-01 20:15') }
  ...
  context 'パーク80' do
    let(:customer_type) { CustomerType::Park80 }

    context '平日' do
      context '~20:00' do
        let(:at) { ScreeningAt.parse('2019-07-10 15:30') }
        it { is_expected.to eq(Fee.new(CustomerType::Park80, DayType::Weekday, ShowType::Normal)) }
      end
      ...
      context '20:00~' do
        ...
        context '通常上映' do
          it { is_expected.to eq(Fee.new(CustomerType::Park80, DayType::Weekday, ShowType::Late)) }
        end
    ...
    context '土日祝' do
      context '~20:00' do
        let(:at) { ScreeningAt.parse('2019-07-13 15:30') }
        it { is_expected.to eq(Fee.new(CustomerType::Park80, DayType::Holiday, ShowType::Normal)) }
      end
      ...
      context '20:00~' do
        ...
        context '通常上映' do
          it { is_expected.to eq(Fee.new(CustomerType::Park80, DayType::Holiday, ShowType::Late)) }
        end
