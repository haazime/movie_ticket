...
describe 'Discount' do
  ...
  context '幼児・小学生' do
    let(:customer_type) { CustomerType::Child.new }
  ...
  context '障がい者（学生以上）' do
    let(:customer_type) { CustomerType::Handicapped::OverStudent.new }
  ...
  context '障がい者（高校以下）' do
    let(:customer_type) { CustomerType::Handicapped::UnderHighSchoolStudent.new }
